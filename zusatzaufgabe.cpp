...
main ()
{
  ...
  // Beim Funktionsaufruf wird die Speicheradresse von a() an set_to_two_ref() übergeben, innerhalb der Funktion wird dieser dereferenziert und auf zwei gesetzt. Nach Funktionsende hat a daher auch in main() den Wert 2. 
